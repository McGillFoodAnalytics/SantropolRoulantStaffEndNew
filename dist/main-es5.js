...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
      ...
      _createClass(UserEventComponent, [{
              ...
              while (1) {
                switch (_context9.prev = _context9.next) {
                  case 0:
                    ...
                    phoneNumPattern = new RegExp("^[0-9]{10}$");
                    this.myForm = this.formBuilder.group({
        ...
        value: function formatDate(date) {
          ...
          if (date.constructor == Date) {
            ...
            var newDate = new Date(parseInt(_year), parseInt(_month) - 1, parseInt(_day));
            var month2 = newDate.toLocaleString('default', {
              month: 'long'
            });
            date = month2 + " " + _day + ", " + _year;
            ;
            return date;
          }
        }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/benjaminemiliani/Santropolroulant/angular-electron/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
