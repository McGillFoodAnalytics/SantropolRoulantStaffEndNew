...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
      ...
      _createClass(FirebaseService, [{
        ...
        value: function addPermanentVolunteer(event_type, user_id, start_date, end_date, frequency) {
          return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
            ...
            var permanent_event_id, validDates, _loop4, i, a;

            return regeneratorRuntime.wrap(function _callee3$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    permanent_event_id = event_type + "_" + start_date.getDate() + frequency + end_date.getMonth() + "_" + user_id[0];
                    ...
                    validDates = this.getDates(new Date(start_date), new Date(end_date), frequency);
                      ...
                      return regeneratorRuntime.wrap(function _loop4$(_context4) {
                        while (1) {
                          switch (_context4.prev = _context4.next) {
                                ...
                                return regeneratorRuntime.wrap(function _loop5$(_context3) {
                                  while (1) {
                                    switch (_context3.prev = _context3.next) {
                                      case 0:
                                        a = _this9.db.object("event/" + validDates[i] + event_type + _this9.pad(j + 1, 2)).valueChanges().subscribe(function (news) {
                                          ...
                                          if (news.uid == user_id[0]) {
                                            ...
                                            flag = true;
                                            console.log("in here:" + validDates[i] + event_type + _this9.pad(j + 1, 2) + " " + flag);

                                            _this9.addUserToEvent(validDates[i] + event_type + _this9.pad(j + 1, 2), user_id[1], user_id[2], user_id[0]);
                                          }
                                        });
                                        _context3.next = 3;
                                        return _this9.delay(500);
                            ...
                            case 3:
                              if (!(j < _this9.eventTypesCool[event_type])) {
                                _context4.next = 8;
                                break;
                              }

                              return _context4.delegateYield(_loop5(j), "t0", 5);
        ...
        key: "getDates",
        value: function getDates(firstDate, lastDate, freq) {
          var validDates = []; //console.log("First date: " + firstDate.toString() + ", Last date: " + lastDate.toString());

          while (firstDate <= lastDate) {
            //push the first Date
            validDates.push(this.getDateNumber(firstDate)); //console.log(firstDate);
            //console.log(freq);

            var incrementInMilliseconds = freq * 7 * 24 * 60 * 60 * 1000;
            firstDate.setTime(firstDate.getTime() + incrementInMilliseconds); //console.log(firstDate);
          }
        ...
        key: "getDateString",
        value: function getDateString(dateval) {
        ...
        key: "getDateNumber",
        value: function getDateNumber(date) {
          var month = "";
          var day = "";
          ...
          var dateString = date.getFullYear().toString().substring(2, 4) + month + day;
          var intDate = +dateString;
          return intDate;
        }
      }, {
        ...
        value: function changeActiveStatus(userid, isActive) {
        ...
        value: function formatEventDates() {
          ...
          this.events.subscribe(function (snapshots) {
            snapshots.forEach(function (snapshot) {
              var event_date = snapshot.event_date.toString();
              var event_type = snapshot.event_type.toString();
              event_date = _this10.formatDate(event_date);

              if (!(event_date in _this10.eventDates)) {
                _this10.eventDates[event_date] = {};
                _this10.eventDates[event_date][event_type] = [snapshot.id];
              } else {
                if (!(event_type in _this10.eventDates[event_date])) {
                  _this10.eventDates[event_date][event_type] = [snapshot.id];
                } else {
                  _this10.eventDates[event_date][event_type].push(snapshot.id);
                }
              }
            });
          });
    ...
    var PermanentVolunteerComponent = /*#__PURE__*/function () {
      ...
      _createClass(PermanentVolunteerComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.volunteersObservable.subscribe(function (snapshots) {
            snapshots.forEach(function (snapshot) {
              _this12.volunteers.push(snapshot);
            });
          });
          this.eventsObservable.subscribe(function (snapshots) {
            snapshots.forEach(function (snapshot) {
              _this12.events.push(snapshot);
            });
          });
          this.addPermanentForm = this.formBuilder.group({
            frequency: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
      ...
      function AuthService(firebaseAuth, db) {
        ...
        this.firebaseAuth.onAuthStateChanged(function (credential) {
          if (credential) {
            ...
            _this13.authStatusSub.next(credential);

            console.log('User is logged in');
          } else {
            _this13.authStatusSub.next(null);
                ...
                switch (_context7.prev = _context7.next) {
                  case 0:
                    ...
                    return this.db.object('/registration_code').valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1)).toPromise().then(function (details) {
                      if (details == code) {
                        return _this14.firebaseAuth.createUserWithEmailAndPassword(email, password).then(function (value) {
                          return __awaiter(_this14, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
                        ...
                        _this14.error = "Registration code is incorrect.";
                        return false;
                      }
                    });
                ...
                switch (_context8.prev = _context8.next) {
                  case 0:
                    ...
                    return this.firebaseAuth.setPersistence(_firebase_app__WEBPACK_IMPORTED_MODULE_4___default.a.auth.Auth.Persistence.LOCAL).then(function () {
                      return _this15.firebaseAuth.signInWithEmailAndPassword(email, password).then(function (value) {
  ...
  function srcAppSignUpSheetEventSignUpTableEventSignUpTableComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".mat-table {\n  width: 100% !important;\n  margin: auto;\n}\n\napp-add-user-to-event {\n  cursor: pointer;\n  float: right;\n}\n\ntd.mat-cell:last-of-type, td.mat-footer-cell:last-of-type, th.mat-header-cell:last-of-type {\n  padding-right: 5px;\n}\n\n.menu:focus {\n  outline: none;\n}\n\n.table-row[isEmpty=true]:hover {\n  background-color: #dfe0df;\n  cursor: pointer;\n}\n\n#noteBtn {\n  width: 1px;\n  height: 1px;\n  z-index: -10px;\n  position: fixed;\n  margin-top: -35px;\n  margin-left: -7px;\n  opacity: 1%;\n  border: 2px;\n}\n\n.menu:hover {\n  background-color: lightgrey;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppSignUpSheetEventSignUpTableEventSignUpTableComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var EventSignUpTableComponent = /*#__PURE__*/function () {
      function EventSignUpTableComponent(modalService, db, fs) {
      ...
      _createClass(EventSignUpTableComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.fs.getUsers().subscribe(function (val) {
            _this16.volunteerList = val;
          });
        }
      }, {
        key: "prettySlot",
    ...
    }), __metadata("design:paramtypes", [_core_services_modalService__WEBPACK_IMPORTED_MODULE_2__["ModalService"], _angular_fire_database__WEBPACK_IMPORTED_MODULE_3__["AngularFireDatabase"], _firebase_service_service__WEBPACK_IMPORTED_MODULE_4__["FirebaseService"]])], EventSignUpTableComponent);
    /***/
  },
  ...
  function srcAppSignUpSheetSignUpSheetComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".page-title {\n  padding-top: 1rem;\n  padding-bottom: 0;\n}\n\n.page-title h1 {\n  padding: 0.5rem;\n  text-align: center;\n  color: #60a4ff;\n}\n\n.container-search {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.volunteer-search {\n  margin-left: 2.5%;\n  margin-top: 1%;\n  width: 400px;\n}\n\n.mat-table {\n  overflow: auto;\n  max-height: 500px;\n  width: 95%;\n  margin-left: 2.5%;\n  margin-right: 2.5%;\n}\n\nth.mat-sort-header-sorted {\n  color: black;\n}\n\n.container {\n  max-width: none;\n  padding: 0;\n}\n\n.container .header {\n  background-color: #5fce99;\n  color: white;\n  padding-top: 0.5rem;\n  padding-bottom: 0.5rem;\n  width: inherit;\n  margin: 0;\n}\n\n.volunteer-name {\n  font-weight: bold;\n  font-size: 16;\n  margin-left: 1rem;\n}\n\n.actions {\n  position: absolute;\n  right: 5%;\n}\n\n.valign-center {\n  display: inline-flex;\n  vertical-align: middle;\n  align-items: center;\n}\n\n.body {\n  background-color: #c1ecd7;\n  padding: 1rem;\n}\n\n.valign-center mat-icon {\n  margin-right: 0.5rem;\n}\n\n.element-detail {\n  overflow: hidden;\n  display: flex;\n}\n\n.element-row {\n  position: relative;\n}\n\n.element-row:not(.expanded) {\n  cursor: pointer;\n}\n\n.element-row:not(.expanded):hover {\n  background: #f5f5f5;\n}\n\n.element-row.expanded {\n  border-bottom-color: transparent;\n}\n\ntr.detail-row {\n  height: 0;\n}\n\ntr.element-row:not(.expanded-row):hover {\n  background: #f5f5f5;\n}\n\ntr.element-row:not(.expanded-row):active {\n  background: #efefef;\n}\n\n.element-row td {\n  border-bottom-width: 0;\n}\n\n.card-header {\n  text-align: center;\n  color: white;\n  background-color: #60a4ff;\n}\n\n#cardTitle {\n  width: 12vw;\n  font-size: 0.96vw;\n}\n\n#cardTitle3 {\n  font-size: 0.96vw;\n}\n\n.card-body {\n  padding: 0;\n  width: 12vw;\n  font-size: 0.96vw;\n}\n\n.kitchenPM .card-body {\n  background-color: #f4abaa;\n}\n\n.row {\n  justify-content: center;\n}\n\n.img-important-event-false {\n  cursor: pointer;\n}\n\napp-permanent-volunteer {\n  float: right;\n  margin-right: 0.5rem;\n  margin-top: 0.2rem;\n  cursor: pointer;\n}\n\n.img-important-event-true {\n  cursor: pointer;\n}\n\n#logo {\n  margin-top: -30px;\n  margin-right: 20%;\n  max-width: 120px;\n  margin-left: -30%;\n  z-index: -1;\n}\n\nh1 {\n  display: inline;\n  text-align: center;\n}\n\nh3 {\n  margin-right: 15px;\n  margin-left: -3.1vw;\n  color: #99169d;\n  position: relative;\n  top: 50%;\n  font-size: 1.5vw !important;\n}\n\n.eventCardImportant {\n  border: 2px solid #f24a5a !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
      ...
      _createClass(SignUpSheetComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.fs.getEvents().subscribe(function (snapshots) {
            ...
            // });
            _this17.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](snapshots);
          ...
          this.db.list('event').auditTrail().subscribe(function (changes) {
            _this17.formatEventDates();

            _this17.volunteers = _this17.fs.getUsers();

            _this17.setVolunteerList();
          });
        }
      }, {
        key: "prettify",
        ...
        value: function setVolunteerList() {
          ...
          this.volunteers.subscribe(function (snapshots) {
            if (_this18.volunteerListInitialized === true) {
              _this18.volunteerList = [];
            }

            _this18.volunteerListInitialized = false;
            snapshots.forEach(function (snapshot) {
              _this18.volunteerList.push(snapshot);
            });
          });
        }
      }, {
        ...
        value: function formatEventDates() {
          ...
          this.events.subscribe(function (snapshots) {
            ...
            _this19.week3 = [];
            snapshots.forEach(function (snapshot) {
              snapshot.event_date = _this19.fs.formatDate(snapshot.event_date.toString());
              var event_type = snapshot.event_type.toString();
              var event_date = snapshot.event_date;

              if (i < events_per_week) {
                if (!(event_type in _this19.week1)) {
                  _this19.week1[event_type] = {};
                }

                if (!(event_date in _this19.week1[event_type])) {
                  _this19.week1[event_type][event_date] = {
                    slots: [],
                    num_volunteers: 0,
                    num_slots: 0,
                    is_important_event: snapshot.is_important_event,
                    display_date: _this19.getDisplayDate(event_date)
                  };
                }

                if (snapshot.first_name) {
                  _this19.week1[event_type][event_date]["num_volunteers"] = _this19.week1[event_type][event_date]["num_volunteers"] + 1;
                }

                _this19.week1[event_type][event_date]["num_slots"] = _this19.week1[event_type][event_date]["num_slots"] + 1;

                _this19.week1[event_type][event_date]["slots"].push(snapshot);
              } else if (i >= events_per_week && i < 2 * events_per_week) {
                if (!(event_type in _this19.week2)) {
                  _this19.week2[event_type] = {};
                }

                if (!(event_date in _this19.week2[event_type])) {
                  _this19.week2[event_type][event_date] = {
                    slots: [],
                    num_volunteers: 0,
                    num_slots: 0,
                    is_important_event: snapshot.is_important_event,
                ...
                if (snapshot.first_name) {
                  _this19.week2[event_type][event_date]["num_volunteers"] = _this19.week2[event_type][event_date]["num_volunteers"] + 1;
                }

                _this19.week2[event_type][event_date]["num_slots"] = _this19.week2[event_type][event_date]["num_slots"] + 1;

                _this19.week2[event_type][event_date]["slots"].push(snapshot);
              } else {
                if (!(event_type in _this19.week3)) {
                  _this19.week3[event_type] = {};
                }

                if (!(event_date in _this19.week3[event_type])) {
                  _this19.week3[event_type][event_date] = {
                    slots: [],
                    num_volunteers: 0,
                    num_slots: 0,
                    is_important_event: snapshot.is_important_event,
                ...
                if (snapshot.first_name) {
                  _this19.week3[event_type][event_date]["num_volunteers"] = _this19.week3[event_type][event_date]["num_volunteers"] + 1;
                }

                _this19.week3[event_type][event_date]["num_slots"] = _this19.week3[event_type][event_date]["num_slots"] + 1;

                _this19.week3[event_type][event_date]["slots"].push(snapshot);
              }

              i = i + 1;
            });
            _this19.weekRange1 = _this19.setWeekRange(_this19.week1);
            _this19.weekRange2 = _this19.setWeekRange(_this19.week2);
            _this19.weekRange3 = _this19.setWeekRange(_this19.week3); //console.log(this.week1);
          });
        }
      }, {
        ...
        value: function getEventListCool(eventType) {
          ...
          if (this.currentWeek == "first") {
            var week1 = Object.keys(this.week1[currentEventValue]);
  ...
  function srcAppToolbarNotificationsNotificationsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var NotificationsComponent = /*#__PURE__*/function () {
      ...
      _createClass(NotificationsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {// this.db.list('event')
  ...
  function srcAppUserEventUserEventComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "@charset \"UTF-8\";\n#no_event {\n  display: flex;\n  justify-content: center;\n  margin-top: 100px;\n  margin-bottom: 100px;\n}\nh4 {\n  margin: 0;\n  display: block;\n  float: left;\n  padding-right: 30px;\n}\nh5 {\n  color: red;\n  margin-top: 40px;\n}\n.mat-icon {\n  vertical-align: middle;\n  margin-left: 8px;\n  margin-right: 12px;\n}\n#title {\n  font-size: 200px;\n}\ntd {\n  font-size: 15px;\n}\ntr {\n  white-space: pre;\n}\n#profile {\n  width: 60vw;\n  position: absolute;\n  /* or absolute */\n  margin-top: 40px;\n  left: 50%;\n  transform: translate(-50%, 0);\n}\n#editProfile {\n  width: 60vw;\n  position: absolute;\n  margin-top: 8px;\n  left: 50%;\n  transform: translate(-50%, -50%);\n}\n#colored {\n  background-color: lightgray;\n}\nbutton {\n  border-radius: 10px;\n}\n#historyBtn {\n  width: 170px;\n  float: right;\n  text-align: center;\n  font-size: 1.25vw;\n  color: white;\n  background-color: #449afe;\n  border-bottom-right-radius: 0px;\n  border-bottom-left-radius: 0px;\n}\n#editBtn {\n  width: 170px;\n  float: right;\n  text-align: center;\n  font-size: 1.25vw;\n  margin-right: 5px;\n  color: white;\n  background-color: #449afe;\n  border-bottom-right-radius: 0px;\n  border-bottom-left-radius: 0px;\n}\n#saveBtn {\n  width: 18%;\n  float: right;\n  text-align: center;\n  font-size: 1.25vw;\n  color: white;\n  background-color: #5fce99;\n  position: absolute;\n  margin-left: 74%;\n  margin-top: 570px;\n  transition: all 0.5s;\n}\n.button span {\n  cursor: pointer;\n  display: inline-block;\n  position: relative;\n  transition: 0.5s;\n}\n.button span:after {\n  content: \"»\";\n  position: absolute;\n  opacity: 0;\n  top: 0;\n  right: -20px;\n  transition: 0.5s;\n}\n.button:hover span {\n  padding-right: 25px;\n}\n.button:hover span:after {\n  opacity: 1;\n  right: 0;\n}\n.input-group {\n  position: fixed;\n  top: 316px;\n  left: 295px;\n  width: 40vw;\n  min-width: 100px;\n}\n.group2 {\n  top: 467px;\n}\ninput {\n  font-size: 15px;\n}\n::-moz-placeholder {\n  font-size: 12px;\n}\n:-ms-input-placeholder {\n  font-size: 12px;\n}\n::-ms-input-placeholder {\n  font-size: 12px;\n}\n::placeholder {\n  font-size: 12px;\n}\n#editInput1 {\n  width: 15vw;\n  position: fixed;\n  top: 268px;\n  left: 295px;\n}\n#editInput2 {\n  width: 6vw;\n}\n#editInput3 {\n  width: 10vw;\n}\n#editInput4 {\n  width: 10vw;\n}\n#editInput5 {\n  width: 7vw;\n}\n#editDate {\n  width: 170px;\n  position: fixed;\n  top: 368px;\n  left: 295px;\n}\n#picker {\n  position: fixed;\n  top: 362px;\n  left: 415px;\n}\n#editInput6 {\n  width: 170px;\n  position: fixed;\n  top: 418px;\n  left: 295px;\n}\n#editInput7 {\n  width: 12vw;\n}\n#editInput8 {\n  width: 12vw;\n}\n#editInput9 {\n  width: 170px;\n  position: fixed;\n  top: 518px;\n  left: 295px;\n}\npre {\n  display: inline;\n  font-family: inherit;\n  font-size: 15px;\n}\ntext {\n  margin-left: 1vw;\n  position: absolute;\n  left: 300px;\n}\ninput.ng-invalid {\n  border: 2px red solid !important;\n}\n#activeIcon {\n  font-size: 40px;\n  margin-top: -28px;\n  margin-left: -8px;\n}\n#scrollable-area {\n  width: 53.8vw;\n  height: 200px;\n  border: 1px solid #ccc;\n  overflow-y: scroll;\n}\nstatus {\n  font-size: 11px;\n  font-style: italic;\n  text-align: center;\n  margin-top: 65px;\n  padding-left: 10px;\n  vertical-align: center;\n}\ninput.apple-switch {\n  position: relative;\n  -webkit-appearance: none;\n  outline: none;\n  width: 47px;\n  height: 27px;\n  background-color: #fff;\n  border: 1px solid #D9DADC;\n  border-radius: 50px;\n  box-shadow: inset -20px 0 0 0 #fff;\n  transform: scale(0.88);\n  margin-bottom: -12px;\n}\ninput.apple-switch:after {\n  content: \"\";\n  position: absolute;\n  top: 1px;\n  left: 1px;\n  background: transparent;\n  width: 24px;\n  height: 24px;\n  border-radius: 50%;\n  box-shadow: 2px 4px 6px rgba(0, 0, 0, 0.2);\n}\ninput.apple-switch:checked {\n  box-shadow: inset 20px 0 0 0 #4ed164;\n  border-color: #4ed164;\n}\ninput.apple-switch:checked:after {\n  left: 20px;\n  box-shadow: -2px 4px 3px rgba(0, 0, 0, 0.05);\n}\n.removeVolBtn {\n  transform: scale(0.7);\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppUserEventUserEventComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UserEventComponent = /*#__PURE__*/function () {
      ...
      _createClass(UserEventComponent, [{
        ...
        key: "changeActiveStatus",
        value: function changeActiveStatus() {
          ...
          this.pastEvents.subscribe(function (snapshots) {
            snapshots.forEach(function (snapshot) {
              if (snapshot.uid == userId) {
                ...
                _this22.pastEventsUser.push(snapshot); //push it to pastEvents
        ...
        value: function displayCurrentEvents(userId) {
          ...
          this.events.subscribe(function (snapshots) {
            snapshots.forEach(function (snapshot) {
              if (!_this23.containsObject(snapshot, _this23.currentEventsUser)) {
                if (snapshot.uid == userId) {
                  //if the model has past events
                  _this23.currentEventsUser.push(snapshot); //push it to pastEvents
          ...
          this.cancelledEvents.subscribe(function (snapshots) {
            snapshots.forEach(function (snapshot) {
              if (snapshot.user_id == userId) {
                _this24.cancelledEventsUser.push(snapshot);
              }
            });
          });
        }
        ...
        value: function checkBox() {
          if (this.element.active_status || this.element.active_status == null) {
            var statusCheckBox = document.getElementById("statusCheck");
            statusCheckBox.checked = true;
          }
        }
      }, {
        key: "formatEventDate",
        value: function formatEventDate(eventId) {
        ...
        key: "formatEventType",
        value: function formatEventType(eventType) {
          var newId;
    ...
    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(), __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])], UserEventComponent.prototype, "removeUserFromEvent", void 0);
        ...
        value: function ngAfterViewInit() {
          ...
          this.fs.getUsers().subscribe(function (snapshots) {
            snapshots.forEach(function (element) {
              element.phone_number = _this26.prettifyPhoneNumber(element.phone_number);
            });
            _this26.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](snapshots);
            _this26.dataSource.sort = _this26.sort; // let temp = Object.keys(this.volunteers[0]);
            // temp = temp.filter(e => !this.displayedColumns.includes(e));
          });
        }
      }, {
